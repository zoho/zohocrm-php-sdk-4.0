...
use com\zoho\crm\api\blueprints\BlueprintsOperations;
use com\zoho\crm\api\blueprints\BodyWrapper;
use com\zoho\crm\api\blueprints\ResponseWrapper;
use com\zoho\crm\api\blueprints\APIException;
use com\zoho\crm\api\record\Record;
use com\zoho\crm\api\blueprints\SuccessResponse;
...
class BluePrint
{
    ...
    public static function getBlueprint(string $moduleAPIName, string $recordId)
    {
        ...
        $bluePrintOperations = new BlueprintsOperations($recordId, $moduleAPIName);
