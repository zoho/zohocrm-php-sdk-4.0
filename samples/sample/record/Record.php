...
class Record
{
	...
	public static function updateRecord(string $moduleAPIName, string $recordId)
	{
		...
		*/
		...
		$lineItemProduct->setId("347706112107031");
	...
	public static function updateRecordUsingExternalId(string $moduleAPIName, string $externalFieldValue)
	{
		...
		*/
		...
		$recordOwner->setEmail("bac@zoho.com");
	...
	public static function createRecords(string $moduleAPIName)
	{
		...
		$multi_select_record->addKeyValue("id", "347706112966050");
		...
		// $record11->setId("312869818786028");
		...
		// $record12->setId("312869818783515");
		...
		$lineItemProduct->setId("347706112261");
		...
		$participant2->addKeyValue("participant", "347706112255001");
	...
	public static function getRecordCount()
	{
		...
		$paramInstance->add(RecordCountParam::phone(), "(990) -");
