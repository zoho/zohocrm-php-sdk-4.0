...
class CreateCases
{
    ...
    public static function createCases($moduleAPIName)
    {
        ...
        $productName->setId("4402400954344");
        ...
        $dealName = new Record();
        $dealName->addKeyValue("id", "44001103110");
        ...
        $dataConsent->setConsentDate(new \DateTime('2021-10-10'));
        ...
        $fileDetail1->setFileId("ae9c7cefa418aec1d6ab35c32a6ae23d729ad87c6d90b0bd44183d280");
        array_push($fileDetails, $fileDetail1);
        $fileDetail2 = new FileDetails();
        $fileDetail2->setFileId("ae9c7cefa418aec1d6a5b35c32a6ae23d729ad87c6d90b0bd44183d2de");
        array_push($fileDetails, $fileDetail2);
        $record1->addKeyValue("File_Upload", $fileDetails);
        // for Custom User LookUp
        $user = new MinifiedUser();
        $user->setId("4222222323123");
        $record1->addKeyValue("User_1", $user);
        // for Custom LookUp
        $data = new Record();
        $data->setId("423244342123");
