...
class UpdateQuotes
{
    ...
    public static function updateQuotes($moduleAPIName)
    {
        ...
        $accountName->addFieldValue(Accounts::id(), "304900004089932");
        ...
        $record1->addFieldValue(Quotes::ValidTill(), date_format(new \DateTime('2023-09-19'), 'y-m-d'));
        ...
        $contactName->setId("345000423434");
...
//        $inventoryLineItem->addKeyValue("Product_Category_1", "hardware");
        ...
        $productLineTax->setId("340000234234234");
        ...
        $record = new Record();
        $record->addKeyValue("id", "4402480084001");
