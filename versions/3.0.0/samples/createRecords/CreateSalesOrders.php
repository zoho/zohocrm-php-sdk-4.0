...
class CreateSalesOrders
{
    ...
    public static function createSalesOrders($moduleAPIName)
    {
        ...
        $lineItemProduct->setId("440248004344");
...
//        $inventoryLineItem->addKeyValue("Product_Category_1", "hardware");
        ...
        $fileDetail1->setFileId("ae9c7cefa418aec9ab35c32a6ae23d729ad87c6d90b0bd44183d280");
        array_push($fileDetails, $fileDetail1);
        $fileDetail2 = new FileDetails();
        $fileDetail2->setFileId("ae9c7cefa418aec1d6a5cc2c32a6ae23d729ad87c6d90b0bd44183d2de");
        array_push($fileDetails, $fileDetail2);
        $record1->addKeyValue("File_Upload", $fileDetails);
        // for Custom User LookUp
        $user = new MinifiedUser();
        $user->setId("422222222323123");
        ...
        $record = new Record();
        $record->addKeyValue("id", "440284001");
