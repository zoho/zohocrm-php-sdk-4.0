...
class CreateCalls
{
    ...
    public static function createCalls($moduleAPIName)
    {
        ...
        // Schedule a call
        $whoId = new Record();
        $whoId->setId("44024001030088");
        $record1->addFieldValue(Calls::WhoId(), $whoId);
        $whatId = new Record();
        $whatId->setId("44024001179025");
        ...
        // log a call
        $whoId1 = new Record();
        $whoId1->setId("4402481030088");
        $record1->addFieldValue(Calls::WhoId(), $whoId1);
        $whatId1 = new Record();
        $whatId1->setId("4402481179025");
        ...
        $fileDetail1->setFileId("ae9c7cefa418aec1d6a5cc2d9ab356ae23d729ad87c6d90b0bd44183d280");
        array_push($fileDetails, $fileDetail1);
        $fileDetail2 = new FileDetails();
        $fileDetail2->setFileId("ae9c7cefa418aec1d6a5cc2dc32a6ae23d729ad87c6d90b0bd44183d2de");
        array_push($fileDetails, $fileDetail2);
        $record1->addKeyValue("File_Upload", $fileDetails);
        // for Custom User LookUp
        $user = new MinifiedUser();
        $user->setId("42222222323123");
        $record1->addKeyValue("User_1", $user);
        // for Custom LookUp
        $data = new Record();
        $data->setId("4232434342123");
