...
class UpdateTasks
{
    ...
    public static function updateTasks($moduleAPIName)
    {
        ...
        $record1->setId("34000003242340023");
...
//        $whoId = new Record();
//        $whoId->setId(3000042340342304);
//        $record1->addFieldValue(Tasks::WhoId(), $whoId);
        $record1->addFieldValue(Tasks::Status(), new Choice("Not Supported"));
        $record1->addFieldValue(Tasks::Priority(), new Choice("Low"));
        $record1->addFieldValue(Tasks::DueDate(), date_format(new \DateTime('2023-10-12'), "y-m-d"));
        ...
        $record = new Record();
        $record->addKeyValue("id", "44024800884001");
        ...
        $record2 = new Record();
        $record2->setId("345000004312324334");
        //
