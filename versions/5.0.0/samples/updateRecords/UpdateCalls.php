...
class UpdateCalls
{
    ...
    public static function updatecalls($moduleAPIName)
    {
        ...
        $record1->setId("3334039404902345");
        // Schedule a call
        $whoId = new Record();
        $whoId->setId("33400423434324");
        $record1->addFieldValue(Calls::WhoId(), $whoId);
        $whatId = new Record();
        $whatId->setId("334000122434324");
