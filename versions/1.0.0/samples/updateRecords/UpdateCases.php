...
class UpdateCases
{
    ...
    public static function updateCases($moduleAPIName)
    {
        ...
        $dealName = new Record();
        $dealName->addKeyValue("id", "300004234324");
