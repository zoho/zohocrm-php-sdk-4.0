...
class UsersTerritoriesOperations
{
	 ...
	 */
	public  function getTerritoriesOfUser(ParameterMap $paramInstance=null)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v4/users/'); 
	 ...
	 * @return APIResponse An instance of APIResponse
	 */
	public  function getSpecificTerritoryOfUser(string $territoryId)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v4/users/'); 
