...
class UsersUnavailabilityOperations
{
	...
	public  function createUsersUnavailability(BodyWrapper $request)
	{
		...
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v4/settings/users_unavailability'); 
	 ...
	 * @return APIResponse An instance of APIResponse
	 */
	public  function getUsersUnavailabilites(ParameterMap $paramInstance=null)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v4/settings/users_unavailability'); 
	 ...
	 * @return APIResponse An instance of APIResponse
	 */
	public  function getUsersUnavailability(string $id, ParameterMap $paramInstance=null)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v4/settings/users_unavailability/'); 
