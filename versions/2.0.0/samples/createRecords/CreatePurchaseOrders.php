...
class CreatePurchaseOrders
{
    ...
    public static function createPurchaseOrders($moduleAPIName)
    {
        ...
        $vendor = new Record();
        $vendor->addFieldValue(Vendors::id(), "34002354235234");
        ...
        $contactName->setId("3400300034421");
        ...
        $lineItemProduct->setId("44020954344");
...
//        $inventoryLineItem->addKeyValue("Product_Category_1", "hardware");
        ...
        $productLineTax->setId("440000020810");
        ...
        $fileDetail1->setFileId("ae9c7cefa418aec1d6a5cc2d9ab329ad87c6d90b0bd44183d280");
        array_push($fileDetails, $fileDetail1);
        $fileDetail2 = new FileDetails();
        $fileDetail2->setFileId("ae9c7cefa418aec1d6a5cc2d9ab23d729ad87c6d90b0bd44183d2de");
        ...
        $record = new Record();
        $record->addKeyValue("id", "440248004001");
