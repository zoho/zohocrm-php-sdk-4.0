...
class CreateCampaigns
{
    ...
    public static function createCampaigns($moduleAPIName)
    {
        ...
        $record1->addFieldValue(Campaigns::StartDate(), new \DateTime('2021-10-10'));
        $record1->addFieldValue(Campaigns::EndDate(), new \DateTime('2021-10-20'));
        ...
        $fileDetail1->setFileId("ae9c7cefa418aec1d6a5cc2d9ab35c3223d729ad87c6d90b0bd44183d280");
        array_push($fileDetails, $fileDetail1);
        $fileDetail2 = new FileDetails();
        $fileDetail2->setFileId("ae9a418aec1d6a5cc2d9ab35c32a6ae23d729ad87c6d90b0bd44183d2de");
