...
class UpdateSalesOrders
{
    ...
    public static function updateSalesOrders($moduleAPIName)
    {
        ...
        $record1->addFieldValue(Sales_Orders::DueDate(), date_format(new \DateTime('2023-08-10'), 'y-m-d'));
...
//        $inventoryLineItem->addKeyValue("Product_Category_1", "hardware");
        ...
        $productLineTax->setId("3400234234234");
        ...
        $record = new Record();
        $record->addKeyValue("id", "4402480884001");
