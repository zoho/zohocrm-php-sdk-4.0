...
class CreateContacts
{
    ...
    public static function createContacts(String $moduleAPIName)
    {
        ...
        $record1->addFieldValue(Contacts::Mobile(), '982');
        $record1->addFieldValue(Contacts::Fax(), 'fax');
        $record1->addFieldValue(Contacts::Assistant(), 'Assistant');
        $record1->addFieldValue(Contacts::DateOfBirth(), date_format(new \DateTime('1990-12-01'), "Y-m-d"));
        $record1->addFieldValue(Contacts::AsstPhone(), '123321');
        $record1->addFieldValue(Contacts::EmailOptOut(), new Choice(true));
        ...
        $fileDetail1->setFileId("ae9c7cefa418aec1d6a5cc2d9ab35c32a6a29ad87c6d90b0bd44183d280");
        array_push($fileDetails,$fileDetail1);
        $fileDetail2 = new FileDetails();
        $fileDetail2->setFileId("ae9c7cefa418aec1d6a5cc2d9ab35ce23d729ad87c6d90b0bd44183d2de");
        array_push($fileDetails,$fileDetail2);
        $record1->addKeyValue("File_Upload", $fileDetails);
        // for Custom User LookUp
        $user = new MinifiedUser();
        $user->setId("422222222222233");
        $record1->addKeyValue("User_1", $user);
        // for Custom LookUp
        $data = new Record();
        $data->setId("423243444342123");
        ...
        $record = new Record();
        $record->addKeyValue("id", "4402400884001");
