...
class CreateAccounts
{
    ...
    public static function createAccounts(String $moduleAPIName)
    {
        ...
        $parent_account->setId("440241103145");
        ...
        $fileDetail1->setFileId("ae9c7cefa418aec1d6a9ab35cae23d729ad87c6d90b0bd44183d280");
        array_push($fileDetails, $fileDetail1);
        $fileDetail2 = new FileDetails();
        $fileDetail2->setFileId("ae9c7cefa418aec1d6ad9ab35cae23d729ad87c6d90b0bd44183d2de");
        array_push($fileDetails, $fileDetail2);
        $record1->addKeyValue("File_Upload", $fileDetails);
        // for Custom User LookUp
        $user = new MinifiedUser();
        $user->setId("4222323123");
