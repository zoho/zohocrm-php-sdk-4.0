...
class CreateProducts
{
    ...
    public static function createProducts(String $moduleAPIName)
    {
       ...
       $record1->addFieldValue(Products::VendorName(), $vendorName);
        ...
        $fileDetail1->setFileId("ae23d729ad87c6d90b0bd44183d280");
        array_push($fileDetails,$fileDetail1);
        $fileDetail2 = new FileDetails();
        $fileDetail2->setFileId("32a6ae23d729ad87c6d90b0bd44183d2de");
        array_push($fileDetails,$fileDetail2);
        $record1->addKeyValue("File_Upload", $fileDetails);
        // for Custom User LookUp
        $user = new MinifiedUser();
        $user->setId("4222222223123");
