...
class CreateSolutions
{
    ...
    public static function createSolutions(String $moduleAPIName)
    {
        ...
        $solutionOwner->setId("44024254001");
        ...
        $fileDetail1->setFileId("ae9c7cefa418aec1d6a5cc2d9ab32a6ae23d729ad87c6d90b0bd44183d280");
        array_push($fileDetails,$fileDetail1);
        $fileDetail2 = new FileDetails();
        $fileDetail2->setFileId("ae9c7cefa418aec1d6a5cc2d9ac32a6ae23d729ad87c6d90b0bd44183d2de");
        ...
        $record = new Record();
        $record->addKeyValue("id", "44024800001");
