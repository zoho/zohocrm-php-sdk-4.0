...
class CreateEvents
{
    ...
    public static function createEvents($moduleAPIName)
    {
        ...
        $whatId = new Record();
        $whatId->setId("440248000001182075");
        ...
        $fileDetail1->setFileId("ae9c7cefa418aec1d6a59ab35c32a6ae23d729ad87c6d90b0bd44183d280");
        array_push($fileDetails, $fileDetail1);
        $fileDetail2 = new FileDetails();
        $fileDetail2->setFileId("ae9c7cefa418aec1d6a5cc2d35c32a6ae23d729ad87c6d90b0bd44183d2de");
        array_push($fileDetails, $fileDetail2);
        $record1->addKeyValue("File_Upload", $fileDetails);
        // for Custom User LookUp
        $user = new MinifiedUser();
        $user->setId("42222222222223");
        ...
        $record = new Record();
        $record->addKeyValue("id", "440200884001");
