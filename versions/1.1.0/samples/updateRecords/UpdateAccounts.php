...
class UpdateAccounts
{
    ...
    public static function updateAccounts(String $moduleAPIName)
    {
        ...
        $record1->setId("340009899934934324");
        ...
        $record1->addFieldValue(Accounts::AccountNumber(), '10000212212');
        ...
        $fileDetail1->setFileId("ae9c7cefa418aec1d6a5cc2d9ab35c32a6ae23d729ad87c6b0bd44183d280");
        array_push($fileDetails, $fileDetail1);
        $fileDetail2 = new FileDetails();
        $fileDetail2->setFileId("ae9c7cefa418aec1d6a5cc2d9ab35c32a6ae23d7ad87c6d90b0bd44183d2de");
